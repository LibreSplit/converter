...
fn parses_livesplit_durations() {
    assert_eq!(
        LiveSplitFile::parse_time("00:01:02.123456789"),
        Some(62123456789)
    );
    assert_eq!(
        LiveSplitFile::parse_time("1.02:03:04.123456789"),
        Some(93784123456789)
    );
    assert_eq!(
        LiveSplitFile::parse_time(" -00:00:05.25"),
        Some(-5250000000)
    );
}
...
fn formats_libresplit_durations() {
    ...
    assert_eq!(
        LiveSplitFile::format_time(93784123456789),
        "26:03:04.123456"
    );
...
fn conversion_for_sub_microsecond_times_are_correct() {
    assert_eq!(
        LiveSplitFile::convert_time("00:00:00.000001999"),
        "00:00:00.000001"
    );
    // this should truncate the 999 and -0 should be just 0.
    assert_eq!(
        LiveSplitFile::convert_time("-00:00:00.000000999"),
        "00:00:00.000000"
    );
}
